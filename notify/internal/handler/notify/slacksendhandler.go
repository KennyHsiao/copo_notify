...
func SlackSendHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SlackSendRequest
		...
		l := notify.NewSlackSendLogic(r.Context(), ctx)
		resp, err := l.SlackSend(req)
		if err != nil {
